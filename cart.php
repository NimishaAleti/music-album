    ...
    <body>
        <div>
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="check.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <footer class="footer">
               <div class="container">
               <center>
                   <p>Follow us on INSTAGRAM</p><br>
                   <p>@nimishaaleti</p><br>
                   <p>@s.a.n.j.a.n.a_01</p><br>
                   <p>@harshu_23</p>
               </center>
               </div>
           </footer>
